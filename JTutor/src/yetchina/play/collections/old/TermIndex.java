 ...
 */
private static TreeMap<String,TreeSet<Integer>>  index;         // Declare the variable.
...
public static void main(String[] args) {
   ...
   try {
      ...
      // Create the data structure that will hold the Term Index.
      ...
      System.out.println(index.size() + " distinct words were found in the file.\n");
      System.out.println();
      if (index.size() == 0) {
      ...
      printIndex();  // Print the data to the output file.
